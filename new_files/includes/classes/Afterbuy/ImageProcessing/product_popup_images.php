...
$a = new image_manipulation(DIR_WS_IMAGES . 'product_images/original_images/' . $products_image_name,PRODUCT_IMAGE_POPUP_WIDTH,PRODUCT_IMAGE_POPUP_HEIGHT,DIR_WS_IMAGES . 'product_images/popup_images/' . $products_image_name,IMAGE_QUALITY,'');
...
@ chmod('product_images/popup_images/' . $image_name, 0644);
